...
gsettings set org.gnome.desktop.background picture-uri "file:///usr/share/icons/Rainier/256x256/app/chromium-browser.png"
...
zenity --info --icon-name=gnome-terminal --text="Now, we need you configure some parts of the desktop yourself. We'll walk you through it."
